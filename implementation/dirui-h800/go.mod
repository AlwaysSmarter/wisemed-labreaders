module wisemed-labreaders/implementation/dirui-h800
...
replace wisemed-labreaders/protocols/stxetxpackages => ../../protocols/stxetxpackages
...
require (
	...
	wisemed-labreaders/protocols/stxetxpackages v0.0.0-00010101000000-000000000000
