...
import (
	...
	"wisemed-labreaders/readersv3/modules/astmspecimen"
	...
	"wisemed-labreaders/readersv3/modules/protocols/anafdocsmart"
	...
	"wisemed-labreaders/readersv3/modules/protocols/biomerieuxminividas"
	...
	"wisemed-labreaders/readersv3/modules/protocols/zoncixl1000i"
...
func RegisterAll(reg *module.Registry) {
	...
	reg.Register("astm-specimen-settings", astmspecimen.New)
	...
	reg.Register("protocol-anaf-docsmart", anafdocsmart.New)
	...
	reg.Register("protocol-zonci-xl1000i", zoncixl1000i.New)
