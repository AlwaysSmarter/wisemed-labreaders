...
func main() {
	cfgPath := flag.String("config", "deployments/config.yaml", "Path to eSignature server config")
	...
	reconfigure := flag.Bool("reconfigure", false, "Run configuration wizard before starting")
