...
func main() {
	...
	modules := []string{"local-http", "storage-sqlite", "events", "wisemed-api", "wisemed-ws", "login", "help", "dashboard", "analytes", "analyte-management", "qc", "result-sync", "stats", "daily-orders", "transport-file", "protocol-cfx96-quantitation"}
